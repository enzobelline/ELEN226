...
// wrapc file define:
#define AUTOTB_TVIN_A_0 "../tv/cdatafile/c.loop_perfect.autotvin_A_0.dat"
#define AUTOTB_TVOUT_A_0 "../tv/cdatafile/c.loop_perfect.autotvout_A_0.dat"
#define AUTOTB_TVIN_A_1 "../tv/cdatafile/c.loop_perfect.autotvin_A_1.dat"
#define AUTOTB_TVOUT_A_1 "../tv/cdatafile/c.loop_perfect.autotvout_A_1.dat"
#define AUTOTB_TVIN_B_0 "../tv/cdatafile/c.loop_perfect.autotvin_B_0.dat"
#define AUTOTB_TVOUT_B_0 "../tv/cdatafile/c.loop_perfect.autotvout_B_0.dat"
#define AUTOTB_TVIN_B_1 "../tv/cdatafile/c.loop_perfect.autotvin_B_1.dat"
#define AUTOTB_TVOUT_B_1 "../tv/cdatafile/c.loop_perfect.autotvout_B_1.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_A_0 "../tv/rtldatafile/rtl.loop_perfect.autotvout_A_0.dat"
#define AUTOTB_TVOUT_PC_A_1 "../tv/rtldatafile/rtl.loop_perfect.autotvout_A_1.dat"
#define AUTOTB_TVOUT_PC_B_0 "../tv/rtldatafile/rtl.loop_perfect.autotvout_B_0.dat"
#define AUTOTB_TVOUT_PC_B_1 "../tv/rtldatafile/rtl.loop_perfect.autotvout_B_1.dat"
...
extern "C" void loop_perfect_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *);

extern "C" void apatb_loop_perfect_hw(volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_B_0, volatile void * __xlx_apatb_param_B_1) {
...
tr.send<1>((char*)__xlx_apatb_param_B_0, 10);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<6> > B_0_pc_buffer(10);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 10; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_B_0)[j*1+0] = B_0_pc_buffer[i].range(5, 0).to_int64();
}}}
        } // end transaction
      } // end file is good
...
if (little_endian()) { tr.reorder(); }
tr.send<1>((char*)__xlx_apatb_param_B_1, 10);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<6> > B_1_pc_buffer(10);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 10; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_B_1)[j*1+0] = B_1_pc_buffer[i].range(5, 0).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
transaction<5> tr(10);
  __xlx_offset_byte_param_A_0 = 0*1;
  if (__xlx_apatb_param_A_0) {
tr.import<1>((char*)__xlx_apatb_param_A_0, 10, 0);
  }
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_A_0 + i * 1;
std::string s = formatData(pos, 5);
...
transaction<5> tr(10);
  __xlx_offset_byte_param_A_1 = 0*1;
  if (__xlx_apatb_param_A_1) {
tr.import<1>((char*)__xlx_apatb_param_A_1, 10, 0);
  }
...
if (__xlx_apatb_param_A_1) {
for (size_t i = 0; i < 10; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_A_1 + i * 1;
std::string s = formatData(pos, 5);
...
transaction<6> tr(10);
  __xlx_offset_byte_param_B_0 = 0*1;
  if (__xlx_apatb_param_B_0) {
tr.import<1>((char*)__xlx_apatb_param_B_0, 10, 0);
  }
...
if (__xlx_apatb_param_B_0) {
for (size_t i = 0; i < 10; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_B_0 + i * 1;
std::string s = formatData(pos, 6);
...
transaction<6> tr(10);
  __xlx_offset_byte_param_B_1 = 0*1;
  if (__xlx_apatb_param_B_1) {
tr.import<1>((char*)__xlx_apatb_param_B_1, 10, 0);
  }
...
if (__xlx_apatb_param_B_1) {
for (size_t i = 0; i < 10; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_B_1 + i * 1;
std::string s = formatData(pos, 6);
...
loop_perfect_hw_stub_wrapper(__xlx_apatb_param_A_0, __xlx_apatb_param_A_1, __xlx_apatb_param_B_0, __xlx_apatb_param_B_1);
