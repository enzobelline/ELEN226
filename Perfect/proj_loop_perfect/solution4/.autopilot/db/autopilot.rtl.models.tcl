set SynModuleInfo {
  {SRCNAME loop_perfect MODELNAME loop_perfect RTLNAME loop_perfect IS_TOP 1
    SUBMODULES {
      {MODELNAME loop_perfect_urem_5ns_5ns_5_9_1 RTLNAME loop_perfect_urem_5ns_5ns_5_9_1 BINDTYPE op TYPE urem IMPL auto LATENCY 8 ALLOW_PRAGMA 1}
      {MODELNAME loop_perfect_mul_5ns_7ns_11_1_1 RTLNAME loop_perfect_mul_5ns_7ns_11_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME loop_perfect_mux_22_5_1_1 RTLNAME loop_perfect_mux_22_5_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
