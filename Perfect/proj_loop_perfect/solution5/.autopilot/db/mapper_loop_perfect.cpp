...
extern "C" void loop_perfect(char*, char*, char*, char*);
extern "C" void apatb_loop_perfect_hw(volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_B_0, volatile void * __xlx_apatb_param_B_1) {
  ...
  for (int i = 0; i < __xlx_A_0__tmp_vec.size(); ++i) {
    __xlx_A_0__input_buffer[i] = __xlx_A_0__tmp_vec[i].range(4, 0).to_uint64();
  }
  // Collect __xlx_A_1__tmp_vec
  vector<sc_bv<5> >__xlx_A_1__tmp_vec;
  for (int j = 0, e = 10; j != e; ++j) {
    __xlx_A_1__tmp_vec.push_back(((char*)__xlx_apatb_param_A_1)[j]);
  }
  int __xlx_size_param_A_1 = 10;
  ...
  for (int i = 0; i < __xlx_A_1__tmp_vec.size(); ++i) {
    __xlx_A_1__input_buffer[i] = __xlx_A_1__tmp_vec[i].range(4, 0).to_uint64();
  }
  // Collect __xlx_B_0__tmp_vec
  vector<sc_bv<6> >__xlx_B_0__tmp_vec;
  for (int j = 0, e = 10; j != e; ++j) {
  ...
  for (int i = 0; i < __xlx_B_0__tmp_vec.size(); ++i) {
    __xlx_B_0__input_buffer[i] = __xlx_B_0__tmp_vec[i].range(5, 0).to_uint64();
  }
  // Collect __xlx_B_1__tmp_vec
  vector<sc_bv<6> >__xlx_B_1__tmp_vec;
  for (int j = 0, e = 10; j != e; ++j) {
  ...
  for (int i = 0; i < __xlx_B_1__tmp_vec.size(); ++i) {
    __xlx_B_1__input_buffer[i] = __xlx_B_1__tmp_vec[i].range(5, 0).to_uint64();
  }
  // DUT call
  loop_perfect(__xlx_A_0__input_buffer, __xlx_A_1__input_buffer, __xlx_B_0__input_buffer, __xlx_B_1__input_buffer);
// print __xlx_apatb_param_A_0
  sc_bv<5>*__xlx_A_0_output_buffer = new sc_bv<5>[__xlx_size_param_A_0];
...
// print __xlx_apatb_param_A_1
  sc_bv<5>*__xlx_A_1_output_buffer = new sc_bv<5>[__xlx_size_param_A_1];
...
// print __xlx_apatb_param_B_0
  sc_bv<6>*__xlx_B_0_output_buffer = new sc_bv<6>[__xlx_size_param_B_0];
...
// print __xlx_apatb_param_B_1
  sc_bv<6>*__xlx_B_1_output_buffer = new sc_bv<6>[__xlx_size_param_B_1];
