...
$(ObjDir)/loop_perfect_test.cpp_pre.cpp.tb.o : loop_perfect_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling loop_perfect_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/loop_perfect.cpp_pre.cpp.tb.o : loop_perfect.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling loop_perfect.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
