...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "loop_perfect.autotvin.dat"
	set constFileTvOut       "loop_perfect.autotvout.dat"
	set constFileHdlTvIn     "loop_perfect.autohdltvin.dat"
	set constFileHdlTvOut    "loop_perfect.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
