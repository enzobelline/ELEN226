...
if {[file isfile loop_perfect.autotvin.dat]} {
	file delete -force loop_perfect.autotvin.dat
}

if {[file isfile loop_perfect.autotvout.dat]} {
	file delete -force loop_perfect.autotvout.dat
}
