...
`define AUTOTB_DUT      loop_perfect
`define AUTOTB_DUT_INST AESL_inst_loop_perfect
`define AUTOTB_TOP      apatb_loop_perfect_top
`define AUTOTB_LAT_RESULT_FILE "loop_perfect.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "loop_perfect.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_loop_perfect_top
...
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.loop_perfect.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.loop_perfect.autotvin_B.dat"
`define AUTOTB_TVOUT_B  "../tv/cdatafile/c.loop_perfect.autotvout_B.dat"
`define AUTOTB_TVOUT_B_out_wrapc  "../tv/rtldatafile/rtl.loop_perfect.autotvout_B.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 409;
parameter LENGTH_A = 20;
parameter LENGTH_B = 20;
...
wire    [4 : 0]    arrayA_address0, arrayA_address1;
wire    [4 : 0]    arrayA_din0, arrayA_din1;
wire    [4 : 0]    arrayA_dout0, arrayA_dout1;
wire    arrayA_ready;
wire    arrayA_done;
...
wire    [4 : 0]    arrayB_address0, arrayB_address1;
wire    [5 : 0]    arrayB_din0, arrayB_din1;
wire    [5 : 0]    arrayB_dout0, arrayB_dout1;
wire    arrayB_ready;
wire    arrayB_done;
...
assign arrayB_we0[0] = B_we0;
assign arrayB_din0 = B_d0;
assign arrayB_we1 = 0;
assign arrayB_din1 = 0;
assign arrayB_ready= ready_initial | arrayB_done;
assign arrayB_done =    AESL_done_delay;
