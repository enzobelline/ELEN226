...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_5ns_5s_12s_12_4_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_12s_13ns_26_4_1_U2", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	loop_perfect {
		...
		B {Type O LastRead -1 FirstWrite 8}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "409", "Max" : "409"}
	, {"Name" : "Interval", "Min" : "410", "Max" : "410"}
]}
...
set Spec2ImplPortList { 
	A { ap_memory {  { A_address0 mem_address 1 5 }  { A_ce0 mem_ce 1 1 }  { A_q0 in_data 0 5 } } }
