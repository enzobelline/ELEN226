...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "inner_product.autotvin.dat"
	set constFileTvOut       "inner_product.autotvout.dat"
	set constFileHdlTvIn     "inner_product.autohdltvin.dat"
	set constFileHdlTvOut    "inner_product.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
