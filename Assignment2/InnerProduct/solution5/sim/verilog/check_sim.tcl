...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.inner_product.autotvin_a_0.dat"
         "c.inner_product.autotvin_a_1.dat"
         "c.inner_product.autotvin_a_2.dat"
         "c.inner_product.autotvin_a_3.dat"
         "c.inner_product.autotvin_b_0.dat"
         "c.inner_product.autotvin_b_1.dat"
         "c.inner_product.autotvin_b_2.dat"
         "c.inner_product.autotvin_b_3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.inner_product.autotvout_s.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
