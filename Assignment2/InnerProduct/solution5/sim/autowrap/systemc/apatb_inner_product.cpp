...
extern "C" void inner_product_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);

extern "C" void apatb_inner_product_hw(volatile void * __xlx_apatb_param_a_0, volatile void * __xlx_apatb_param_a_1, volatile void * __xlx_apatb_param_a_2, volatile void * __xlx_apatb_param_a_3, volatile void * __xlx_apatb_param_b_0, volatile void * __xlx_apatb_param_b_1, volatile void * __xlx_apatb_param_b_2, volatile void * __xlx_apatb_param_b_3, volatile void * __xlx_apatb_param_s) {
...
tr.import<2>((char*)__xlx_apatb_param_a_0, 2, 0);
  }
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_a_0 + i * 2;
...
tr.import<2>((char*)__xlx_apatb_param_a_1, 2, 0);
  }
...
if (__xlx_apatb_param_a_1) {
for (size_t i = 0; i < 2; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_a_1 + i * 2;
std::string s = formatData(pos, 16);
...
tr.import<2>((char*)__xlx_apatb_param_a_2, 2, 0);
  }
...
if (__xlx_apatb_param_a_2) {
for (size_t i = 0; i < 2; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_a_2 + i * 2;
std::string s = formatData(pos, 16);
...
tr.import<2>((char*)__xlx_apatb_param_a_3, 2, 0);
  }
...
if (__xlx_apatb_param_a_3) {
for (size_t i = 0; i < 2; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_a_3 + i * 2;
std::string s = formatData(pos, 16);
...
tr.import<2>((char*)__xlx_apatb_param_b_0, 2, 0);
  }
...
if (__xlx_apatb_param_b_0) {
for (size_t i = 0; i < 2; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_b_0 + i * 2;
std::string s = formatData(pos, 16);
...
tr.import<2>((char*)__xlx_apatb_param_b_1, 2, 0);
  }
...
if (__xlx_apatb_param_b_1) {
for (size_t i = 0; i < 2; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_b_1 + i * 2;
std::string s = formatData(pos, 16);
...
tr.import<2>((char*)__xlx_apatb_param_b_2, 2, 0);
  }
...
if (__xlx_apatb_param_b_2) {
for (size_t i = 0; i < 2; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_b_2 + i * 2;
std::string s = formatData(pos, 16);
...
tr.import<2>((char*)__xlx_apatb_param_b_3, 2, 0);
  }
...
if (__xlx_apatb_param_b_3) {
for (size_t i = 0; i < 2; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_b_3 + i * 2;
std::string s = formatData(pos, 16);
...
inner_product_hw_stub_wrapper(__xlx_apatb_param_a_0, __xlx_apatb_param_a_1, __xlx_apatb_param_a_2, __xlx_apatb_param_a_3, __xlx_apatb_param_b_0, __xlx_apatb_param_b_1, __xlx_apatb_param_b_2, __xlx_apatb_param_b_3, __xlx_apatb_param_s);
