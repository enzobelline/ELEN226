set SynModuleInfo {
  {SRCNAME inner_product MODELNAME inner_product RTLNAME inner_product IS_TOP 1
    SUBMODULES {
      {MODELNAME inner_product_mux_32_16_1_1 RTLNAME inner_product_mux_32_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME inner_product_mux_42_16_1_1 RTLNAME inner_product_mux_42_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME inner_product_mul_mul_16s_16s_16_4_1 RTLNAME inner_product_mul_mul_16s_16s_16_4_1 BINDTYPE op TYPE all IMPL dsp48 LATENCY 3 ALLOW_PRAGMA 1}
