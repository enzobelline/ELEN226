...
if {[file isfile inner_product.autotvin.dat]} {
	file delete -force inner_product.autotvin.dat
}

if {[file isfile inner_product.autotvout.dat]} {
	file delete -force inner_product.autotvout.dat
}
