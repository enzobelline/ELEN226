...
set C_modelArgList {
	{ a int 16 regular {array 8 { 1 3 } 1 1 }  }
	{ b int 16 regular {array 8 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ s sc_out sc_lv 16 signal 2 } 
	{ s_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Loop" : [
			{"Name" : "inner_product_loop", "PipelineType" : "no",
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 3 }  { a_ce0 mem_ce 1 1 }  { a_q0 in_data 0 16 } } }
	b { ap_memory {  { b_address0 mem_address 1 3 }  { b_ce0 mem_ce 1 1 }  { b_q0 in_data 0 16 } } }
