...
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.mmul.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.mmul.autotvout_a.dat"
#define AUTOTB_TVIN_b "../tv/cdatafile/c.mmul.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.mmul.autotvout_b.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.mmul.autotvout_a.dat"
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.mmul.autotvout_b.dat"
...
extern "C" void mmul_hw_stub_wrapper(volatile void *, volatile void *, volatile void *);

extern "C" void apatb_mmul_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
tr.import<2>((char*)__xlx_apatb_param_a, 12, 0);
  }
aesl_fh.write(AUTOTB_TVIN_a, tr.p, tr.tbytes);
}

  tcl_file.set_num(12, &tcl_file.a_depth);
#else
...
transaction<16> tr(24);
  __xlx_offset_byte_param_b = 0*2;
  if (__xlx_apatb_param_b) {
tr.import<2>((char*)__xlx_apatb_param_b, 24, 0);
  }
aesl_fh.write(AUTOTB_TVIN_b, tr.p, tr.tbytes);
}

  tcl_file.set_num(24, &tcl_file.b_depth);
#else
...
mmul_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_c);
