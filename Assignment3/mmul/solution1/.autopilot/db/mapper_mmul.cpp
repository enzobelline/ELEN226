...
extern "C" void mmul(short*, short*, short*);
extern "C" void apatb_mmul_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
  ...
  // DUT call
  mmul(__xlx_a__input_buffer, __xlx_b__input_buffer, __xlx_c__input_buffer);
