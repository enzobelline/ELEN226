...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mmul.autotvin.dat"
	set constFileTvOut       "mmul.autotvout.dat"
	set constFileHdlTvIn     "mmul.autohdltvin.dat"
	set constFileHdlTvOut    "mmul.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
