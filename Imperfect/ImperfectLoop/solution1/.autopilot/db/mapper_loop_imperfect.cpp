...
extern "C" void loop_imperfect(char*, char*);
extern "C" void apatb_loop_imperfect_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B) {
  ...
  for (int i = 0; i < __xlx_A__tmp_vec.size(); ++i) {
    __xlx_A__input_buffer[i] = __xlx_A__tmp_vec[i].range(4, 0).to_uint64();
  }
  // Collect __xlx_B__tmp_vec
  vector<sc_bv<6> >__xlx_B__tmp_vec;
  for (int j = 0, e = 20; j != e; ++j) {
  ...
  for (int i = 0; i < __xlx_B__tmp_vec.size(); ++i) {
    __xlx_B__input_buffer[i] = __xlx_B__tmp_vec[i].range(5, 0).to_uint64();
  }
  // DUT call
  loop_imperfect(__xlx_A__input_buffer, __xlx_B__input_buffer);
// print __xlx_apatb_param_A
  sc_bv<5>*__xlx_A_output_buffer = new sc_bv<5>[__xlx_size_param_A];
...
// print __xlx_apatb_param_B
  sc_bv<6>*__xlx_B_output_buffer = new sc_bv<6>[__xlx_size_param_B];
