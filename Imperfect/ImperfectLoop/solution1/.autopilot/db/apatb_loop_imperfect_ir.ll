; ModuleID = 'Z:/ECC/Desktop/Winter2023/ELEN226/Midterm/ImperfectLoop/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_loop_imperfect_ir(%"struct.ap_int<5>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="20" %A, %"struct.ap_int<6>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="20" %B) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_loop_imperfect_hw(i5* %2, i6* %3)
...
declare void @apatb_loop_imperfect_hw(i5*, i6*)
...
define void @loop_imperfect_hw_stub_wrapper(i5*, i6*) #4 {
entry:
  ...
  call void @loop_imperfect_hw_stub(%"struct.ap_int<5>"* %6, %"struct.ap_int<6>"* %7)
  call void @copy_in([20 x %"struct.ap_int<5>"]* %2, [20 x i5]* %4, [20 x %"struct.ap_int<6>"]* %3, [20 x i6]* %5)
  ret void
}

declare void @loop_imperfect_hw_stub(%"struct.ap_int<5>"*, %"struct.ap_int<6>"*)
