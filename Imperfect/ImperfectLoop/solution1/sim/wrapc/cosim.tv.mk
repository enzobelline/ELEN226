...
$(ObjDir)/loop_imperfect_test.cpp_pre.cpp.tb.o : loop_imperfect_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling loop_imperfect_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/loop_imperfect.cpp_pre.cpp.tb.o : loop_imperfect.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling loop_imperfect.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
