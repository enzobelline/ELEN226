...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Apps/Xilinx/Vitis_HLS/2022.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Apps/Xilinx/Vitis_HLS/2022.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Apps/Xilinx/Vitis_HLS/2022.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Apps/Xilinx/Vitis_HLS/2022.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "loop_imperfect.autotvin.dat"
	set constFileTvOut       "loop_imperfect.autotvout.dat"
	set constFileHdlTvIn     "loop_imperfect.autohdltvin.dat"
	set constFileHdlTvOut    "loop_imperfect.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
