...
if {[file isfile loop_imperfect.autotvin.dat]} {
	file delete -force loop_imperfect.autotvin.dat
}

if {[file isfile loop_imperfect.autotvout.dat]} {
	file delete -force loop_imperfect.autotvout.dat
}
