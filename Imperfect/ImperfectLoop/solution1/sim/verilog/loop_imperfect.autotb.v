...
`define AUTOTB_DUT      loop_imperfect
`define AUTOTB_DUT_INST AESL_inst_loop_imperfect
`define AUTOTB_TOP      apatb_loop_imperfect_top
`define AUTOTB_LAT_RESULT_FILE "loop_imperfect.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "loop_imperfect.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_loop_imperfect_top
...
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.loop_imperfect.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.loop_imperfect.autotvin_B.dat"
`define AUTOTB_TVOUT_B  "../tv/cdatafile/c.loop_imperfect.autotvout_B.dat"
`define AUTOTB_TVOUT_B_out_wrapc  "../tv/rtldatafile/rtl.loop_imperfect.autotvout_B.dat"
module `AUTOTB_TOP;
